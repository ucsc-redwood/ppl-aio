...
void RegisterMonteCarloPiBenchmarks(int num_cores) {
...
void RegisterMatrixMultiplicationBenchmarks(int num_cores) {
  for (int core_id = 0; core_id < num_cores; ++core_id) {
...
void RegisterGraphTraversalBenchmarks(int num_cores) {
  for (int core_id = 0; core_id < num_cores; ++core_id) {
...
int main(int argc, char** argv) {
  ...
  RegisterMonteCarloPiBenchmarks(num_cores);
  RegisterMatrixMultiplicationBenchmarks(num_cores);
  RegisterGraphTraversalBenchmarks(num_cores);
