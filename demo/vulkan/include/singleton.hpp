...
class Singleton {
 public:
  ...
  VkResult createBuffer(VkBufferUsageFlags usageFlags,
                        ...
                        VkDeviceSize size,
                        void *data = nullptr);
  void createSharedBuffer(VkBufferUsageFlags usageFlags,
                          VkMemoryPropertyFlags memoryPropertyFlags,
                          VkBuffer *buffer,
                          VkDeviceMemory *memory,
                          VkDeviceSize size,
 ...
 protected:
  ...
  void create_compute_queue() {
    ...
    vulkan12Features.storageBuffer8BitAccess =
        VK_TRUE;  // Enable 8-bit storage buffers
  ...
  void create_query_pool() {
    ...
    vkCreateQueryPool(
        device, &query_pool_info, nullptr, &query_pool_timestamps);
  }
...
VkResult Singleton::createBuffer(VkBufferUsageFlags usageFlags,
                                 VkMemoryPropertyFlags memoryPropertyFlags,
                                 VkBuffer *buffer,
                                 VkDeviceMemory *memory,
                                 VkDeviceSize size,
...
void Singleton::createSharedBuffer(VkBufferUsageFlags usageFlags,
                                   VkMemoryPropertyFlags memoryPropertyFlags,
                                   VkBuffer *buffer,
                                   VkDeviceMemory *memory,
                                   VkDeviceSize size,
